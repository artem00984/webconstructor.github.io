...
let showAddMenuHandler = function(evt) {
	...
	const addMenuElemet = parentElement.querySelector('.choose-elem');
	addMenuElemet.classList.toggle('hidden');
}
...
const addElementHandler = function (evt) {
	...
	const addMenuElemet = clickedBtn.parentNode;
	addMenuElemet.classList.add('hidden');
